...
!
  ...
  CONTAINS
    ...
    use prescribed_dummy,    only: init_prescribed_dummy_restart
    ...
    if ( .not. adiabatic .and. .not. ideal_phys )then
       ...
       call init_prescribed_dummy_restart(File)
...
!
  ...
  subroutine write_restart_physics (File, cam_out, pbuf2d)
      ...
      use prescribed_dummy,   only: write_prescribed_dummy_restart
      ...
      if ( .not. adiabatic .and. .not. ideal_phys )then
         ...
         call write_prescribed_dummy_restart(File)
...
!#######################################################################
    ...
    subroutine read_restart_physics (File, cam_out,pbuf2d)
     ...
     use prescribed_dummy,   only: read_prescribed_dummy_restart
     ...
     if ( .not. adiabatic .and. .not. ideal_phys )then
        ...
        call read_prescribed_dummy_restart(File)
