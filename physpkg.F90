module physpkg
! search for DUMMY/dummy to see changes
  !-----------------------------------------------------------------------
  ! Purpose:
  !
...
subroutine phys_register
    ...
    use prescribed_dummy,   only: prescribed_dummy_register  ! added
    ...
    if (moist_physics) then
       ...
       call prescribed_dummy_register()  ! added
...
subroutine phys_init( phys_state, phys_tend, pbuf2d, cam_out )
    ...
    use prescribed_dummy,   only: prescribed_dummy_init ! added
    ...
    call prescribed_dummy_init() ! added
...
!-----------------------------------------------------------------------------------
  ...
  use prescribed_dummy,    only: prescribed_dummy_adv ! added
  ...
  call prescribed_dummy_adv(phys_state, pbuf2d) ! added
